":" ; exec cl-launch -Q -sm scripts/src/touchpad "$0" "$@"
;; -*- lisp -*-
...
(uiop:define-package #:scripts/src/touchpad
  (:use #:cl
        #:inferior-shell
        #:cl-scripting
        #:optima
...
(in-package #:scripts/src/touchpad)
...
(defun main (argv) ;; TODO: use command-line-arguments, or CLON
  (cond
    ...
    (t (if-let (fun (package-function :scripts/src/touchpad (standard-case-symbol-name (first argv))))
